...
newsgroupSampleStyleData <- read.table("/home/srmq/Documents/Research/textmining/devel/data/20_newsgroups-sample10-VisualAndReadabilityFeatures-Matrix.txt", header=FALSE, colClasses=c("integer", "integer", "numeric"), col.names=c("row", "col", "val"), skip=1)
...
writeMM(DissimsExport, file="/home/srmq/Documents/Research/textmining/devel/data/20_newsgroups-sample10-VisualAndReadabilityFeatures-Dissims.mtx")
