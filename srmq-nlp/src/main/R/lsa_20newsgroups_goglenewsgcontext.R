...
ndocs <- ndocs[1, 1]
newsgroupSampleData <- read.table("/home/srmq/Documents/Research/textmining/devel/data/20_newsgroups-sample10-GoogleNewsVectors-Matrix.txt", header=FALSE, colClasses=c("integer", "integer", "numeric"), col.names=c("row", "col", "val"), skip=1)
...
writeMM(DissimsExport, file="/home/srmq/git/nlp/srmq-nlp/experiments/20newsgroups-sample10-lsa50GoogleNewsGContext-Dissims.mtx")
