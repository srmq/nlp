...
ndocs <- read.table("/home/srmq/Documents/Research/textmining/devel/data/20_newsgroups-noheaders-sample10-multilex-indices/lemmas-extra/df.txt", header=FALSE, nrows=1, colClasses=c("numeric"))

ndocs <- ndocs[1, 1]

wordList <- readLines("/home/srmq/Documents/Research/textmining/devel/data/20_newsgroups-noheaders-sample10-multilex-indices/lemmas-extra/words.lst")

numFeatures <- length(wordList)


newsgroupSampleData <- read.table("/home/srmq/Documents/Research/textmining/devel/data/20_newsgroups-noheaders-sample10-multilex-indices/lemmas-extra/20newsSample10-MultilexLemmas-OccurMatrix.txt", header=FALSE, colClasses=c("integer", "integer", "numeric"), col.names=c("row", "col", "val"), skip=1)
...
dfTable <- read.table("/home/srmq/Documents/Research/textmining/devel/data/20_newsgroups-noheaders-sample10-multilex-indices/lemmas-extra/df.txt", header=FALSE, skip=1, colClasses=c("numeric"))
...
writeMM(DissimsExport, file="/home/srmq/Documents/Research/textmining/devel/data/20_newsgroups-noheaders-sample10-multilex-indices/lemmas-extra/20newsgroups-sample10-MultilexLEMMAS-NoStopW-noRare3-lsa50-Dissims.mtx")
