...
stopPos <- sapply(1:length(wordList), function(i) wordList[i] %in% stopWords)
...
writeMM(DissimsExport, file="/home/srmq/Documents/Research/textmining/devel/data/20_newsgroups-noheaders-sample10-multilex-indices/words-extra/20newsgroups-sample10-MultilexWORDS-NoStopW-lsa50-Dissims.mtx")
