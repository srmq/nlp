...
ndocs <- ndocs[1, 1]
reutersRT10Data <- read.table("/home/srmq/git/nlp/srmq-nlp/experiments/dtw201609/reuters21578-RT10-LSA/reuters21578-RT10-OccurMatrix.txt", header=FALSE, colClasses=c("integer", "integer", "numeric"), col.names=c("row", "col", "val"), skip=1)

reutersRT10Data$val <- log(reutersRT10Data$val)

reutersRT10Data$val <- reutersRT10Data$val + 1
 
reutersSampleMatrix <- sparseMatrix(i=reutersRT10Data$row, j=reutersRT10Data$col, x=reutersRT10Data$val, dims=c(130000, ndocs))

rm(reutersRT10Data)

dfTable <- read.table("/home/srmq/git/nlp/srmq-nlp/experiments/dtw201609/reuters21578-RT10-df.txt", header=FALSE, skip=1, colClasses=c("numeric"))
df <- rep(0, 130000)
...
writeMM(DissimsExport, file="/home/srmq/git/nlp/srmq-nlp/experiments/dtw201609/reuters21578-RT10-LSA/reuters21578-RT10-lsa50-Dissims.mtx")
