...
ndocs <- read.table("/home/srmq/Documents/Research/textmining/devel/data/reuters21578/ModApteTestWithBodySingleTopic/multilex-tokenization-indices/words-extra/df.txt", header=FALSE, nrows=1, colClasses=c("numeric"))

ndocs <- ndocs[1, 1]

wordList <- readLines("/home/srmq/Documents/Research/textmining/devel/data/reuters21578/ModApteTestWithBodySingleTopic/multilex-tokenization-indices/words-extra/words.lst")

numFeatures <- length(wordList)


newsgroupSampleData <- read.table("/home/srmq/Documents/Research/textmining/devel/data/reuters21578/ModApteTestWithBodySingleTopic/multilex-tokenization-indices/words-extra/reuters21578-MultilexWORDS-OccurMatrix.txt", header=FALSE, colClasses=c("integer", "integer", "numeric"), col.names=c("row", "col", "val"), skip=1)
...
dfTable <- read.table("/home/srmq/Documents/Research/textmining/devel/data/reuters21578/ModApteTestWithBodySingleTopic/multilex-tokenization-indices/words-extra/df.txt", header=FALSE, skip=1, colClasses=c("numeric"))
...
writeMM(DissimsExport, file="/home/srmq/Documents/Research/textmining/devel/data/reuters21578/ModApteTestWithBodySingleTopic/multilex-tokenization-indices/words-extra/reuters21578-RT10-MultilexWORDS-NoStopW-noRare3-lsa50-Dissims.mtx")
